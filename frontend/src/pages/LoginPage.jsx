    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-background">
      ...
      <Card className="w-full max-w-md relative z-10 border-border/50 bg-card/80 backdrop-blur">
        <CardHeader className="text-center">
          ...
          <CardDescription>Sign in to your PlayTraderz account</CardDescription>
        </CardHeader>
        ...
        <CardContent className="space-y-6">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <Button type="submit" className="w-full neon-glow" disabled={loading} data-testid="login-submit-btn">
